...
def run_simulation_proposal_IGA(NUM_GENERATIONS=9, PROPOSAL_POPULATION_SIZE=200, EVALUATE_SIZE=9, evaluate_num=0, interpolate_num=0, times:int=1, noise_is_added:bool=False, look: bool = False, tournament_size=3, w:float=0.425):
    best_fitness_history = []
    average_fitness_history = []
    error_history = []
    distance_history = []
